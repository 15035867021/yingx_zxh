...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">应学视频App后台管理系统
                <small>v1.0</small>
            </a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#">你好: ${sessionScope.admin.username}</a></li>
                <li><a href="${path}/admin/loginOut">退出系统</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
                        ...
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                               href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                <span class="glyphicon glyphicon-apple"></span>类别管理
                            </a>
                        </h4>
                    </div>
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <button class="btn btn-warning">
                                <a href="javascript:$('#mainId').load('${path}/video/showVideo.jsp')">视频展示</a></button>
                            <br><br>
                            <button class="btn btn-warning">视频搜索</button>
                        </div>
                    </div>
                </div>
                        ...
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                               href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                <span class="glyphicon glyphicon-apple"></span>反馈管理
                            </a>
                        </h4>
                    </div>
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <button class="btn btn-danger">
                                <a href="javascript:$('#mainId').load('${path}/feedBack/showFeedBack.jsp')">反馈信息/a></button>
                        </div>
                    </div>
                </div>
...
<nav class="navbar navbar-default navbar-fixed-bottom" style="padding-top: 15px">
    <div class="container" style="text-align: center">
        <p>联系邮箱:zhang_xh624@163.com</p>
        <p>百知教育&copy;@&reg;传媒有限公司</p
    </div>
</nav>
<!--栅格系统-->
